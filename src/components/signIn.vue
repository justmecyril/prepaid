<template>
  <div class="fixed inset-0 z-10 hidden overflow-y-auto" id="sign_in_modal" v-if="!showSignInModal">
    <div class="flex items-end justify-center px-4 pb-20 text-center sm:block">
      ...
      <div
        class="inline-block overflow-hidden text-left align-middle transition-all transform rounded-lg shadow-xl "
      >
        <!-- Add margin if you want to see some of the overlay behind the modal-->
        <div class="px-6 py-4 text-left">
          <div>
            <div
              class="w-full overflow-hidden text-gray-500 bg-white shadow-xl rounded-3xl"
                    ...
                    <div>
                      <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                          <div class="flex">
                            ...
                            >
                              <i
                                class="text-lg text-gray-400 mdi mdi-lock-outline"
                              ></i>
                            </div>
                            <input
                              type="email"
                              class="w-full py-2 pl-10 pr-3 -ml-10 bg-gray-100 border rounded-lg outline-none "
                      ...
                      <div class="flex">
                        <div class="w-full px-3 mb-5">
                          <button
                            class="w-full px-3 py-3 font-semibold text-white capitalize bg-green-900 rounded-lg "
                          >
                            Sign In
                          </button>
                        </div>
